    ...
    <main className="flex flex-1 flex-col items-center justify-center gap-8 p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Link
            href="/patient"
            className="flex flex-col items-center gap-2 rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm hover:border-blue-300 hover:bg-blue-50/40"
          >
